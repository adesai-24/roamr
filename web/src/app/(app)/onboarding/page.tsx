...
export default async function OnboardingPage() {
  ...
  // Middleware sends anyone who already has a username straight to the app, so
  // this is the belt to that braces: reaching this page with a username means
  // middleware did not run, and re-claiming would only ever be a mistake.
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted text-sm">
          This is how friends find you — the one thing roamr needs before any of it is useful.
        </p>
      </div>
